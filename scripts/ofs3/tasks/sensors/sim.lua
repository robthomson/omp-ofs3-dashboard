...
local lastCacheFlushTime = ofs3.clock
...
local function flushCacheIfNeeded()
    if ofs3.clock - lastCacheFlushTime >= cacheExpireTime then
        sensors.uid = {}
        sensors.lastvalue = {}
        lastCacheFlushTime = ofs3.clock
    end
end
...
--[[
    ...
    1. Checks the current time using `ofs3.clock`.
