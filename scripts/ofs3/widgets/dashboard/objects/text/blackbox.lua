...
local function eraseDataflash()
    isErase = true
    progress = form.openProgressDialog(ofs3.i18n.get("app.msg_saving"), ofs3.i18n.get("app.msg_saving_to_fbl"))
    progress:value(0)
...
function render.wakeup(box)
    ...
    if totalSize and usedSize then
        ...
        displayValue = string.format("%." .. decimals .. "f/%." .. decimals .. "f %s",
            transformedUsed, transformedTotal, ofs3.i18n.get("app.modules.status.megabyte"))
    else
